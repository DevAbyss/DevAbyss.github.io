...
// 기본 Template
const defaultTemplate = fs.readFileSync("../templates/default.html", "utf8");

// Navigation Template
const navTemplate = fs.readFileSync("../templates/nav.html", "utf8");

// Article Template
const articleListTemplate = fs.readFileSync(
